                ...
                <div class="md:col-span-2 border-t border-dashed border-slate-200 pt-4 mt-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="minimal_grosir" value="{{ old('minimal_grosir', 0) }}" min="0" class="w-full rounded-xl border-slate-200 text-sm focus:border-indigo-500 focus:ring-indigo-200">
